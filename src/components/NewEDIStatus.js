...
export class NewEDIStatus extends Component {
  constructor(props) {
    super(props);
    ...
    this.saveEDIstatuspayer = this.saveEDIstatuspayer.bind(this);
  ...
  async componentDidMount() {
    ...
    if (this.state.editId > 0) {
      await axios
        .get(this.url + "FindEdi276Payer/" + this.state.editId, this.config)
        .then(response => {
  ...
  saveEDIstatuspayer = e => {
    if (this.saveEDIStatusCount == 1) {
      return;
    }
    this.saveEDIStatusCount = 1;
    this.setState({ loading: true });
    ...
    // e.preventDefault();
    axios
      .post(this.url + "SaveEdi276Payer", this.state.EDIModel, this.config)
      .then(response => {
        this.saveEDIStatusCount = 0;
                ...
                <div class="col-md-12 order-md-1 provider-form ">
                  ...
                  <div class="col-12 text-center">
                    <button
                      class="btn btn-primary mr-2"
                      type="submit"
                      onClick={this.saveEDIstatuspayer}
...
export default connect(mapStateToProps, matchDispatchToProps)(NewEDIStatus);
