...
class ChargeBarChart extends Component {
  constructor(props) {
    super(props);
        ...
        <div>
          <ResponsiveContainer width="100%" height={200}>
            ...
            >
              ...
              <Tooltip />
              <Legend />
              <Bar dataKey="charges" stackId="charges" fill="#3367d6" />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </React.Fragment>
...
export default connect(mapStateToProps, matchDispatchToProps)(ChargeBarChart);
