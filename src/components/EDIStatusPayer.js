...
export class EDIStatusPayer extends Component {
  constructor(props) {
    super(props);

    this.url = process.env.REACT_APP_URL + "/Edi276Payer/";
    ...
    this.searchStatusPayer = this.searchStatusPayer.bind(this);
  ...
  onKeyDown(keyName, e, handle) {
    ...
    if (keyName == "alt+n") {
      // alert("search key")
      this.openStatusPopup(0);
      console.log(e.which);
    } else if (keyName == "alt+s") {
      this.searchStatusPayer(e);
      console.log(e.which);
  ...
  searchStatusPayer = e => {
    ...
    axios
      .post(this.url + "FindEdi276Payers", this.state.searchModel, this.config)
      .then(response => {
        let newList = [];
        response.data.map((row, i) => {
          ...
          newList.push({
            ...
            payerID: (
                ...
                <a
                href=""
                  onClick={(event) => this.openStatusPopup(event , row.id)} 
                >
                  {row.payerId}
                </a>
    ...
    return (
        ...
        <div className="card mb-4 bg-info">
          <div className="card-body">
            <div className="table-responsive">
              ...
              EDI STATUS PAYER SEARCH
                 <button
                  href=""
                  style={{ marginTop: "-6px" }}
                  className="float-right btn-search btn-primary btn-user"
                  onClick={event => this.openStatusPopup(event)}
              ...
              <form onSubmit ={this.searchStatusPayer}>
                <div className="row">
      ...
      <div className="container-fluid">
        <div className="card mb-4">
          <GridHeading
            Heading="EDI STATUS SEARCH RESULT"
...
export default connect(mapStateToProps, matchDispatchToProps)(EDIStatusPayer);
