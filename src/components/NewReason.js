...
export class NewReason extends Component {
  ...
  handleCheck() {
    ...
    this.setState({
      reasonModel: {
        ...
        isActive: !this.state.reasonModel.isActive
      }
    });
  }
  ...
  async componentWillMount() {
    ...
    try {
      ...
      if (this.state.editId > 0) {
        await axios
          .get(this.url + "FindReason/" + this.state.editId, this.config)
          .then(response => {
  ...
  saveReason = e => {
    if (this.saveReasonCount == 1) {
      return;
    }
    this.saveReasonCount = 1;
    ...
    if (this.isNull(this.state.reasonModel.userID)) {
    ...
    e.preventDefault();
    axios
      .post(this.url + "SaveReason", this.state.reasonModel, this.config)
      .then(response => {
        this.saveReasonCount = 0;
  ...
  render() {
    const isActive = this.state.reasonModel.isActive;
    //Spinner
    let spiner = "";
                ...
                <div class="col-md-12 order-md-1 provider-form ">
                  ...
                  <div class="header pt-1">
                    <h3>
                      {
                     this.state.editId > 0
                     ? this.state.reasonModel.name.toUpperCase() 
                     : "NEW REASON "}
                    </h3>
                  ...
                  <div class="col-md-4 mb-2">
                    ...
                    <label for="firstName">User ID <span
                      ...
                      <select
                                ...
                                name="userID"
                                id="userID"
                                value={this.state.reasonModel.userID}
                                onChange={this.handleChange}>
