...
class NewPatientSheet extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      PatientSheetModel: this.PatientSheetModel,
      showPopup: false,
      loading: false,
      maxHeight: "361",
      filePath: "",
    ...
    this.LoadPatientSheetData = this.LoadPatientSheetData.bind(this);
  ...
  LoadPatientSheetData() {
    ...
    console.log("patientsheetmodel", this.state.PatientSheetModel);
    ...
    if (this.isNull(this.state.PatientSheetModel.type)) {
    ...
    if (this.isNull(this.state.PatientSheetModel.providerID)) {
      myVal.providerVal = (
    ...
    if (this.isNull(this.state.PatientSheetModel.locationID)) {
      myVal.locationVal = (
    ...
    if (this.isNull(this.state.PatientSheetModel.uploadModel.content)) {
    ...
    //////////////// Change API call on basis of type
    let apiMethod = "";
    if (this.state.PatientSheetModel.type) {
      if (this.state.PatientSheetModel.type == "OFFICEALLY") {
        apiMethod = "AddPatientData";
      }
      if (this.state.PatientSheetModel.type == "SMARTSHEET - EXCEL") {
        apiMethod = "AddPatiensFromSmartSheetExcel";
      }
    }

    axios
      .post(
        this.AddPatientSheet + apiMethod,
        this.state.PatientSheetModel,
        this.config
      )
      .then((response) => {
      ...
      .catch((error) => {
        ...
        if (error.response) {
          if (error.response.status) {
            if (error.response.data == "Duplicate Sheet") {
              this.setState({ loading: false });
              Swal.fire(error.response.data, "Data Already Exists", "error");
              return;
  ...
  render() {
    ...
    const TypeOptions = [
      ...
      { value: "SMARTSHEET - EXCEL", display: "SMART SHEET - EXCEL " },
    ];
                  ...
                  <div class="col-md-12 order-md-1 provider-form ">
                    ...
                    <div class="row">
                      <div class="col-md-6 mb-2">
                        ...
                        <div class="col-md-8 float-left">
                          <select
                            ...
                            name="type"
                            id="type"
                            value={this.state.PatientSheetModel.type}
                      ...
                      <div class="col-md-6 mb-2">
                        ...
                        <div class="col-md-8 float-left" style={{marginBottom:"-22px"}}>
                          <label
                            for="file-upload"
                     ...
                     <div class="col-md-6 mb-2">
                        ...
                        <div class="col-md-8 float-left">
                          <select
                            ...
                            name="providerID"
                            id="providerID"
                            value={this.state.PatientSheetModel.providerID}
                            onChange={this.handleChange}
                          >
                      ...
                      <div class="col-md-6 mb-2">
                        ...
                        <div class="col-md-8 float-left">
                          <select
                            ...
                            name="locationID"
                            id="locationID"
                            value={this.state.PatientSheetModel.locationID}
                            onChange={this.handleChange}
                          >
                    ...
                    <div class="col-12 text-center">
                      <button
                        ...
                        type="submit"
                        onClick={this.LoadPatientSheetData}
...
export default connect(mapStateToProps, matchDispatchToProps)(NewPatientSheet);
