...
export class ElectronicSubmissionModel extends Component {
  constructor(props) {
    super(props);
    ...
    this.downloadEDIFile = this.downloadEDIFile.bind(this);
  }
  ...
  downloadEDIFile() {
    ...
    axios
      .get(this.url + "DownloadEDIFile/" + this.state.logSubmitId, {
        headers: {
                ...
                <div class="row ml-0 mr-0 w-100">
                  <div class="col-md-12 order-md-1 provider-form ">
                    <div class="header pt-1">
                      <h3>ELECTRONIC CLAIM SUBMISSION SEARCH RESULT</h3>
